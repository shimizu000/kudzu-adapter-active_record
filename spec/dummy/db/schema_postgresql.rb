...
ActiveRecord::Schema.define(version: 20171023054358) do
  ...
  create_table "kudzu_chunks", id: :serial, force: :cascade do |t|
    t.integer "page_id"
    t.binary "data"
  ...
  create_table "kudzu_links", id: :serial, force: :cascade do |t|
    t.text "uuid"
    t.text "url"
    t.text "title"
    t.integer "state"
  ...
  create_table "kudzu_pages", id: :serial, force: :cascade do |t|
    t.text "url"
    t.text "title"
    t.integer "status"
    t.text "mime_type"
